...
$('body').click(function(e){
    // console.log('1',$(e.target).hasClass('radio-yes-1'));
    var p =$('#collapseFive').find('.form-spacing:nth-child(5)')[0];
    // console.log($(p).find('cust-dir'))
     $(p).find('cust-dir').addClass('form-spacing');



    if($(e.target).hasClass('radio-yes-1')){
        $(e.target).addClass("active-button");
        $(e.target).next().removeClass("active-button");
        $(e.target).parents('.row:first').next().show();
    } else if($(e.target).hasClass('radio-no-1')){
        $(e.target).prev().removeClass("active-button");
        $(e.target).addClass("active-button");
        $(e.target).prev().parents('.row:first').next().hide();
    } else if($(e.target).attr('href')=='step-3.html#collapseTwo' || $(e.target).attr('href')=='step-3.html#collapseFive'){
        $('.radio-yes-1').removeClass("active-button");
        $('.radio-no-1').addClass("active-button");
        $('.radio-yes-1').parents('.row:first').next().hide();
        $('.radio-yes-1').each(function( index ) {
...
$( document ).ready(function() {
    console.log('uhfh',$('.panel-collapse.collapse'))
