...
myApp.service("datajQueryModel",function($rootScope){
	$( document ).ready(function() {
	//alert("Hello Ajay! I am an alert box!");
	...
	// Make Dynamic
		 $('.radio-sal-3').click(function() {
        //$('.collapseExample-3').slideDown();
        $('.radio-sal-3').addClass("active-button");
        $('.radio-self-3').removeClass("active-button");
        console.log("CALLED")
    });

    $('.radio-self-3').click(function() {
        //$('.collapseExample-3').slideUp();
        $('.radio-self-3').addClass("active-button");
        $('.radio-sal-3').removeClass("active-button");
    });
